...
favoriteThings.food = `Chicken Niggets`
...
let cat1 = new Cat (`Cutlet`, 4, `orange`)
...
let wizard1 = new Wizard (`Merlin`, 1000, `Fireball`)
...
let phone1 = new Phone(`Nokia`, `3310`, 1, `grey`, 1000)
let phone2 = new Phone(`iPhone`, `3g`, 2, `black`, 999)
let phone3 = new Phone (`Motorolla`, `Razor13`, 3, `silver`, 990)
...
let myFirstVehicle = new Vehicle (3.2, `black`, 32000)

console.log (myFirstVehicle.move(1000))
...
let myFirstMotocycle = new Motorcycle(0.7, `black`, 15000, `Suzuki`, `cool`)

/*
  Call the move function on myFirstMotorcycle (don't forget the parameter)
*/

console.log (myFirstMotocycle.move(5000))
...
let myFirstBoat = new Boat (0.5, `blue`, 5000, `Cool Boat`, `yacht`, false)
